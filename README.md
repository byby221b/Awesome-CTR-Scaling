...
| **Scaling Laws for Behavioral Foundation Models over User Event Sequences** | Stanford / MIT | arXiv | 2026 | [[Paper]](https://arxiv.org/abs/2606.05257) | Systematic scaling law study for behavioral foundation models across ~600 runs and 10^15-10^19 FLOPs; reveals compute-optimal embedder size (~2%), data-heavy training, and metric-dependent scaling dynamics |
